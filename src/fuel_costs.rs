use crate::{
    BASE_FUEL_COST, CALL_FUEL_COST, DROP_KEEP_PER_FUEL, ENTITY_FUEL_COST, LOAD_FUEL_COST,
    LOCALS_PER_FUEL, MEMORY_BYTES_PER_FUEL, STORE_FUEL_COST, TABLE_ELEMS_PER_FUEL,
};
